  ...
  render: function DefaultStory() {
    ...
    return (
      <div>
        ...
        >
          <p>
            You are about to send <strong>$450.00</strong> to Chidi Okonkwo.
          </p>
    ...
    return (
      <div>
        ...
        <Modal open={open} onClose={() => setOpen(false)}>
          <p>
            This modal has no title bar. Useful for simple confirmations or
            image lightboxes.
          </p>
        </Modal>
      </div>
  ...
  render: function AllExamplesStory() {
    ...
    return (
      <div style={{ display: 'flex', gap: '0.75rem' }}>
        ...
        >
          <p>
            Send <strong>$450.00 USD</strong> → <strong>₦697,500.00 NGN</strong>
          </p>
          <p style={{ color: '#64748b', fontSize: '0.875rem' }}>
            Rate: 1 USD = 1,550 NGN
          </p>
          <div
            style={{
              display: 'flex',
        ...
        >
          <p>
            <strong>Reference:</strong> RF-2024-07890
          </p>
          <p>
            <strong>Status:</strong> Completed ✅
          </p>
          <p>
            <strong>Date:</strong> Jul 18, 2026
          </p>
        </Modal>
