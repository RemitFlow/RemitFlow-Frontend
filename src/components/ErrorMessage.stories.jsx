...
export const LongMessage = {
  args: {
    message:
      'We were unable to process your transfer due to a temporary issue with the Stellar network. Your funds have not been deducted. Please wait a few moments and try again.',
    onRetry: () => alert('Retrying…'),
  },
};
